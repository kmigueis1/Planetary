...
const marsMove = System.enablePlanet(mars, 100, 75, [0,0,0], scene);


let jupiter = System.createPlanet(5, Util.planetColors("red"));
const jupiterMove = System.enablePlanet(jupiter, 100, 100, [0,0,0], scene);


let uranus = System.createPlanet(5, Util.planetColors("aqua"));
const uranusMove = System.enablePlanet(uranus, 100, 120, [0,0,0], scene);


let neptune = System.createPlanet(5, Util.planetColors("pale yellow"));
const neptuneMove = System.enablePlanet(neptune, 100, 130, [0,0,0], scene);


let pluto = System.createPlanet(5, Util.planetColors("tan"));
const plutoMove = System.enablePlanet(pluto, 100, 150, [0,0,0], scene);
